...
let LoggerService = LoggerService_1 = class LoggerService {
    ...
    initWinston() {
        ...
        const webTransport = new winston_daily_rotate_file_1.default(Object.assign(transportOptions, { filename: this.options.appLogName }));
        const errorTransport = new winston_daily_rotate_file_1.default(Object.assign(transportOptions, {
    ...
    updateAndGetTimestampDiff() {
        const includeTimestamp = LoggerService_1.lastTimestampAt && this.options?.timestamp;
