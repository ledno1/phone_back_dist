...
__decorate([
    (0, typeorm_1.Column)({ name: 'is_ext', type: 'boolean', nullable: true, default: false }),
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Boolean)
], SysMenu.prototype, "isExt", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'open_mode', type: 'tinyint', nullable: true, default: 1 }),
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Number)
], SysMenu.prototype, "openMode", void 0);
SysMenu = __decorate([
