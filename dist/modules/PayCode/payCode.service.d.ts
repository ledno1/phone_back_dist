...
export declare class PayCodeService implements OnModuleInit {
    private channelService;
    private redisService;
    private entityManager;
    private util;
    constructor(channelService: ChannelService, redisService: RedisService, entityManager: EntityManager, util: UtilService);
