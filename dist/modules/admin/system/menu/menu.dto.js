...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '是否外链', required: false, default: true }),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateMenuDto.prototype, "isExt", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '外链打开方式', required: false, default: 1 }),
    (0, class_validator_1.IsIn)([1, 2]),
    (0, class_validator_1.ValidateIf)((o) => o.isExt === true),
    __metadata("design:type", Number)
], CreateMenuDto.prototype, "openMode", void 0);
__decorate([
