...
export declare class ALiPayHandlerService implements ServiceHandler, OnModuleInit {
    ...
    constructor(redisService: RedisService, entityManager: EntityManager, topUserService: TopService, proxyUserService: ProxyService, orderQueue: Queue, paramConfigService: SysParamConfigService, channelService: ChannelService, util: UtilService, adminWSService: AdminWSService, codeService: CodeService);
